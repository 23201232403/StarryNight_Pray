...
chemical_bath.recipeBuilder()
    ...
    .outputs([<metaitem:dustManaInfusedResidue>*3])
    .EUt(7680)
    .duration(300)
    .buildAndRegister();
...
chemical_bath.recipeBuilder()
    ...
    .outputs(<metaitem:dustLumiumPyrotheum>)
    .duration(40)
    .EUt(7680)
    .buildAndRegister();
...
chemical_bath.recipeBuilder()
    ...
    .outputs(<metaitem:dustSignalumFluorescent>)
    .duration(40)
    .EUt(7680)
    .buildAndRegister();
...
chemical_bath.recipeBuilder()
    ...
    .outputs(<metaitem:dustEnderiumCryotheum>)
    .duration(40)
    .EUt(7680)
    .buildAndRegister();
