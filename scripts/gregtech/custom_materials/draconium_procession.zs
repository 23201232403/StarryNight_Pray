...
chemical_reactor.recipeBuilder()
    ...
    .outputs(<metaitem:dustNaquadriaHydroxide>*7,<gregtech:meta_dust:101>*3)
    .EUt(480)
    .duration(480)
    .buildAndRegister();
...
chemical_reactor.recipeBuilder()
    ...
    .fluidOutputs([<liquid:water>*1000,<liquid:nquadric_acid>*1000])
    .EUt(30720)
    .duration(90)
    .buildAndRegister();
...
chemical_bath.recipeBuilder()
    ...
    .fluidInputs([<liquid:nquadric_acid>*5000])
...
centrifuge.recipeBuilder()
    ...
    .notConsumable(<gregtech:meta_item_1:207>*2)
    .fluidOutputs([<liquid:nquadric_acid>*1900])
    .outputs([<metaitem:dustDragonEssence>*4,<gregtech:meta_dust:329>*3,<gregtech:meta_dust:372>*3,<gregtech:meta_dust:280>*4])
    .duration(420)
    .EUt(1920)
    .buildAndRegister();
...
distillery.recipeBuilder()
    ...
    .fluidOutputs([<liquid:nquadric_acid>*800])
    .circuit(1)
    .outputs(<metaitem:dustCrudeDraconiumResidue>*6)
    .duration(800)
    .EUt(480)
    .buildAndRegister();
...
autoclave.recipeBuilder()
    ...
    .inputs([<metaitem:dustCrudeDraconiumResidue>*3,<ore:dustCalcium>])
    .outputs([<metaitem:dustDraconium>,<gregtech:meta_dust:346>*3])
    .duration(40)
    .EUt(7680)
    .buildAndRegister();
...
chemical_bath.recipeBuilder()
    ...
    .outputs([<metaitem:dustEmpoweredDraconium>*36])
    .duration(1050)
    .EUt(122880)
    .buildAndRegister();
...
electric_blast_furnace.recipeBuilder()
    ...
    .chancedOutput(<metaitem:dustAdamantine>,5000,250)
    .duration(900)
    .EUt(122880)
    .circuit(0)
...
mixer.recipeBuilder()
    ...
    .inputs([<deepmoblearning:living_matter_extraterrestrial>*8,<deepmoblearning:living_matter_hellish>*8,<deepmoblearning:living_matter_overworldian>*8,])
    .fluidOutputs([<liquid:space_coolant>*20000])
    .duration(400)
    .EUt(7680)
    .buildAndRegister();
//热觉醒龙素锭
